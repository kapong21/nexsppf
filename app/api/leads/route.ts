...
// In-memory rate limit (per-instance — production should swap for Upstash)
...
export async function POST(req: NextRequest) {
  ...
  // TODO: forward to CRM/Sanity/Sheets/Slack — sprint 4
  // For now: structured server log, ready to ship into any pipeline.
