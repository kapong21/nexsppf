...
import { TECH_LAYERS, TECH_BENEFITS, BRAND, CTA } from '@/data/brand';
      ...
      <section className="page-hero">
        <div className="container">
          ...
          <p className="lede thai" style={{ marginTop: 20, maxWidth: 720 }}>
            ...
            ขั้นกาว ไปจนถึง release liner เพื่อให้ได้ finish ที่ใส เรียบเนียน ทนทาน และติดตั้งได้อย่างมั่นใจ
          </p>
        </div>
      </section>
