...
import { FAQ_PUBLIC, CTA } from '../data/brand.js';

// FAQ accordion (reusable)
export const Faq = ({ items = FAQ_PUBLIC }) => {
    ...
    <section className="page-hero">
      <div className="container">
        ...
        <p className="lede thai" style={{marginTop:20, maxWidth:680}}>
          คำตอบสำหรับคำถามที่ลูกค้าและร้านติดตั้งสอบถามบ่อยที่สุด
          หากไม่พบคำตอบที่ต้องการ ติดต่อทีมงานได้ตลอดเวลา
        </p>
      </div>
    </section>
