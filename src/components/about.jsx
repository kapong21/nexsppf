...
import { BRAND_STORY, NEXS_STANDARD, TECH_BENEFITS, BRAND, CTA } from '../data/brand.js';

// About NEXS page — brand story + NEXS standard cards + technology summary
        ...
        <div className="grid-2" style={{gap:64, alignItems:"center"}}>
          <div>
            ...
            <p className="lede thai" style={{marginTop:20}}>
              แบรนด์ฟิล์มที่พัฒนาจากความเข้าใจในผิวรถจริง งานติดตั้งจริง
              และมาตรฐานของเจ้าของรถระดับพรีเมียม
            </p>
